...
#define N_HISTORY_SNAPS 9
#define MERAXES_GITREF_STR "ae6221faa841a0cd13c47d9557f6d374f29f4e7e"
#define MERAXES_GITDIFF_STR ""

#ifdef CALC_MAGS
#define MAGS_N_SNAPS 3
#define MAGS_N_BANDS 6
...
typedef struct physics_params_t {
    ...
    double ReionNionPhotPerBaryPopIII;
...
void read_trees__extended_gbptrees(int snapshot, halo_t* halo, int n_halos, fof_group_t* fof_group, int n_fof_groups, int n_requested_forests, int* n_halos_kept, int* n_fof_groups_kept, int* index_lookup);
...
double calc_ejected_mass(double* m_reheat, double sn_energy, double Vvir, double fof_Vvir);
