...
double init_ps(){
  ...
  fprintf(stderr, "find_HII_bubbles:: For M_DM = %.2e keV, R_CUTOFF is: %.2e comoving Mpc\n", M_WDM, R_CUTOFF);
  if (!P_CUTOFF)
    fprintf(stderr, "find_HII_bubbles:: But you have selected CDM, so this is ignored\n");
