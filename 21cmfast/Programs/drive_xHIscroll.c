...
int main(int argc, char ** argv){
  ...
  while (1){
    ...
    case 2:
      if (USE_HALO_FIELD)
	sprintf(cmnd, "gen_size_distr %06.2f 0 ../Boxes/xH_nf*_eff%.1f_HIIfilter%i_Mmin%.1e_RHIImax%.0f_z%06.2f_%i_%.0fMpc", Z, ion_eff, HII_FILTER, M_MIN, R_BUBBLE_MAX, Z, HII_DIM, BOX_LEN);
      else
	sprintf(cmnd, "gen_size_distr %06.2f 0 ../Boxes/xH_nohalos_nf*_eff%.1f_HIIfilter%i_Mmin%.1e_RHIImax%.0f_z%06.2f_%i_%.0fMpc", Z, ion_eff, HII_FILTER, M_MIN, R_BUBBLE_MAX, Z, HII_DIM, BOX_LEN);
      break;
    default:
      if (USE_HALO_FIELD)
	sprintf(cmnd, "gen_size_distr %06.2f 0 ../Boxes/sphere_xH_nf*_eff%.1f_HIIfilter%i_Mmin%.1e_RHIImax%.0f_z%06.2f_%i_%.0fMpc", Z, ion_eff, HII_FILTER, M_MIN, R_BUBBLE_MAX, Z, HII_DIM, BOX_LEN);
      else
	sprintf(cmnd, "gen_size_distr %06.2f 0 ../Boxes/sphere_xH_nohalos_nf*_eff%.1f_HIIfilter%i_Mmin%.1e_RHIImax%.0f_z%06.2f_%i_%.0fMpc", Z, ion_eff, HII_FILTER, M_MIN, R_BUBBLE_MAX, Z, HII_DIM, BOX_LEN);
    }
    time(&curr_time);
    fprintf(stderr, "Now calling: %s, %g min have ellapsed\n", cmnd, difftime(start_time, curr_time)/60.0);
    fprintf(LOG, "Now calling: %s, %g min have ellapsed\n", cmnd, difftime(start_time, curr_time)/60.0);
    ...
    case 2:
      if (USE_HALO_FIELD)
	sprintf(cmnd, "gen_size_distr %06.2f 1 ../Boxes/xH_nf*_eff%.1f_HIIfilter%i_Mmin%.1e_RHIImax%.0f_z%06.2f_%i_%.0fMpc", Z, ion_eff, HII_FILTER, M_MIN, R_BUBBLE_MAX, Z, HII_DIM, BOX_LEN);
      else
	sprintf(cmnd, "gen_size_distr %06.2f 1 ../Boxes/xH_nohalos_nf*_eff%.1f_HIIfilter%i_Mmin%.1e_RHIImax%.0f_z%06.2f_%i_%.0fMpc", Z, ion_eff, HII_FILTER, M_MIN, R_BUBBLE_MAX, Z, HII_DIM, BOX_LEN);
      break;
    default:
      if (USE_HALO_FIELD)
	sprintf(cmnd, "gen_size_distr %06.2f 1 ../Boxes/sphere_xH_nf*_eff%.1f_HIIfilter%i_Mmin%.1e_RHIImax%.0f_z%06.2f_%i_%.0fMpc", Z, ion_eff, HII_FILTER, M_MIN, R_BUBBLE_MAX, Z, HII_DIM, BOX_LEN);
      else
	sprintf(cmnd, "gen_size_distr %06.2f 1 ../Boxes/sphere_xH_nohalos_nf*_eff%.1f_HIIfilter%i_Mmin%.1e_RHIImax%.0f_z%06.2f_%i_%.0fMpc", Z, ion_eff, HII_FILTER, M_MIN, R_BUBBLE_MAX, Z, HII_DIM, BOX_LEN);
    }
    time(&curr_time);
    fprintf(stderr, "Now calling: %s, %g min have ellapsed\n", cmnd, difftime(start_time, curr_time)/60.0);
    fprintf(LOG, "Now calling: %s, %g min have ellapsed\n", cmnd, difftime(start_time, curr_time)/60.0);
    ...
    case 2:
      if (USE_HALO_FIELD)
	sprintf(cmnd, "delta_T %06.2f ../Boxes/xH_z%06.2f_nf*_eff%.1f_HIIfilter%i_Mmin%.1e_RHIImax%.0f_%i_%.0fMpc",  Z, Z, ion_eff, HII_FILTER, M_MIN, R_BUBBLE_MAX, HII_DIM, BOX_LEN);
      else
	sprintf(cmnd, "delta_T %06.2f ../Boxes/xH_nohalos_z%06.2f_nf*_eff%.1f_HIIfilter%i_Mmin%.1e_RHIImax%.0f_%i_%.0fMpc", Z, Z, ion_eff, HII_FILTER, M_MIN, R_BUBBLE_MAX, HII_DIM, BOX_LEN);
      break;
    default:
      if (USE_HALO_FIELD)
	sprintf(cmnd, "delta_T %06.2f ../Boxes/sphere_xH_z%06.2f_nf*_eff%.1f_HIIfilter%i_Mmin%.1e_RHIImax%.0f_%i_%.0fMpc", Z, Z, ion_eff, HII_FILTER, M_MIN, R_BUBBLE_MAX, HII_DIM, BOX_LEN);
      else
	sprintf(cmnd, "delta_T %06.2f ../Boxes/sphere_xH_nohalos_z%06.2f_nf*_eff%.1f_HIIfilter%i_Mmin%.1e_RHIImax%.0f_%i_%.0fMpc", Z, Z, ion_eff, HII_FILTER, M_MIN, R_BUBBLE_MAX, HII_DIM, BOX_LEN);
    }
    time(&curr_time);
    fprintf(stderr, "Now calling: %s, %g min have ellapsed\n", cmnd, difftime(start_time, curr_time)/60.0);
    fprintf(LOG, "Now calling: %s, %g min have ellapsed\n", cmnd, difftime(start_time, curr_time)/60.0);
